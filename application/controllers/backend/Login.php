...

{
  ...
  {  
    ...
    if(!$this->upload->do_upload('sub_userfile'))  
    ...
    {  
      ...
      $this->db->where('id', $this->input->post('sub_cat_id'));  
    ...
    $data = array(
      ...
      'featured_image' => $this->input->post('featured_image_i'),
...
{  
  ...
  { 
    ...
    if(!$this->upload->do_upload('Uuserfile'))  
  ...
  if (isset($_POST['vender_detail'])) {
    ...
    if($_FILES['business_proof']['name']!=""){
      ...
      $value=array('business_proof'=>$new_image_name,
        'name'=>$this->input->post('name'),
        'id'=>$this->input->post('Commerce_id'),
