    ...
    class Manage_vendors extends CI_Controller {
        ...
        public function saveOffers(){
            ...
            if(!empty($post)){
                ...
                $aminities = implode(",",$newArr['amenities']);
                $subCat = implode(",", $newArr['sub_cat_name']);
                ...
                $insertArr = array(
                    ...
                    'category_id' => $newArr['category_id'],
                    'sub_cat_name' => $subCat ? $subCat : "",
                    'aminities' => $aminities ? $aminities : ""
                );
