	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?php echo base_url();?>backend/Supports/aboutUs_save" method="POST" id="AddAboutUsForm">
					<div class="row">
						<div class="col-12">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form action="<?php //echo base_url('backend/Supports/findUs_update);?>" method="POST" id="UpdateAboutUsForm">
                    <div class="row">
						<div class="col-12">
                            <input type="hidden" name="about_id" id="AUAboutUs_id" value="">
							<div class="form-group">
								<label for="">Text En</label>
								<textarea name="AUdesc_en" id="AUdesc_en" class="form-control" placeholder="Text En" value=""></textarea>
							</div>
                            <div class="form-group">
								<label>Text Ar</label>
								<textarea  name="AUdesc_ar" id="AUdesc_ar" class="form-control" placeholder="Text Ar" value=""></textarea>
							</div>
						</div>
						<div class="col-12">
