                  ...
                  <div class="card-body">
                    ...
                    <div class="row pb-2 p-2">
                      ...
                      <div class="col-md-6 text-right">
                        <p class="mb-0"><strong>Invoice Date</strong>: <?php echo date('d-M-yy H:i:s'); ?></p>
                        ...
                        <tfoot class="font-weight-bold small">
                          ...
                          <tr>
                            <td colspan="8">Amount in words: Rs One Thusend Five Hundrate only 
                              <span class="float-right" id="balance">Balance:0</span>
                            </td>
                          </tr>
                          <tr>
  ...
  var setInvoice = function(rowId,vendorId){
    $.ajax({
      ...
      success:function(data){
          ...
          let no_unit = getInfo.result[0].no_unit;
          if((no_unit == "") || (no_unit == undefined)){
            var qty_amt = getInfo.result[0].amount;
          } else {
            var qty_amt = parseFloat(getInfo.result[0].no_unit) * parseFloat(getInfo.result[0].amount);
          }
          
          var dis_amt = (parseFloat(qty_amt)  - parseFloat(getInfo.result[0].discount));
          // var min_amt = parseFloat(getInfo.result[0].amount) - parseFloat(dis_amt);
          var vat_amt = (parseFloat(dis_amt) * parseFloat(getInfo.result[0].vat)) / 100;
          var total = parseFloat(dis_amt) + parseFloat(vat_amt);
          $("#qtyTotal").html(qty_amt);
          $("#TDiscount").html(dis_amt);
          $("#TtaxAMt").html(vat_amt);
          $("#Ttotal").html(total);
          $("#name").html(getInfo.result[0].vendor_name);
          $("#campion_name").html(getInfo.result[0].campain_name);
          $("#amount").html(getInfo.result[0].amount);
          $("#vat").html(getInfo.result[0].vat+" %");
          $("#discount").html(getInfo.result[0].discount);
          $("#quantity").html(getInfo.result[0].no_unit);
          $("#subtotal").html(vat_amt);
          $("#total").html(total);
