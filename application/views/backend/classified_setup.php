              ...
              <table class="table table-bordered table-hover" id="example">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><button class="btn btn-success" onclick="getClassifiedInfo('<?php echo $value['id']; ?>');" data-toggle="modal" data-target="#classifiedUpdate">Update</button></td>
                  </tr>
                  <?php $i++; }} ?>
                </tbody>
              </table>
...
<!-- The Modal -->
<div class="modal" id="classifiedUpdate">
  <div class="modal-dialog">
    <div class="modal-content">
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Update Classified Setup</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>
      <!-- Modal body -->
      <div class="modal-body">
        <form action="" method="POST" id="ClassifiedUpdateForm">
          <div class="row">
            <div class="col-12">
...
<script>
    var getClassifiedInfo = function(id){
        $.ajax({
            type : "POST",
            url : "<?php echo base_url();?>backend/Membership/getLimitedInfo",
            data : {id:id, type:'classified'},
  ...
  $(document).ready(function() {
    ...
    form.validate({
      ...
      submitHandler: function (form) {
        ...
        $.ajax({
          type: 'POST',
          url: '<?php echo base_url();?>backend/Membership/update_setup',
