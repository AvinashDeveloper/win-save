	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?php echo base_url();?>backend/Supports/contactUs_save" method="POST" id="AddContactForm">
					<div class="row">
						<div class="col-6">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form action="" method="POST" id="UpdateContactForm">
                    <div class="row">
						<div class="col-6">
                            <input type="hidden" name="CUContactUs_id" id="CUContactUs_id" value="">
							<div class="form-group">
								<label for="">Question En.</label>
								<input type="text" name="CUtitle_en" id="CUtitle_en" class="form-control" placeholder="Title En" value="">
							</div>
							<div class="form-group">
								<label for="">Info</label>
								<input type="text" name="CUinfo" id="CUinfo" class="form-control" placeholder="Info" value="">
							</div>
						</div>
                        <div class="col-6">
							<div class="form-group">
								<label for="">Title Ar</label>
								<input type="text" name="CUtitle_ar" id="CUtitle_ar" class="form-control" placeholder="Title Ar" value="">
							</div>
                            <div class="form-group">
								<label>Priority</label>
								<input type="number" min='1' name="CUpriority" id="CUpriority" class="form-control" placeholder="set priority" value="">
							</div>
						</div>
						<div class="col-12">
