                  ...
                  <table class="table  display">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><button class="btn btn-success" onclick="getInventoryItem('<?php echo $value['id']; ?>','<?php echo $value['shop_name']; ?>');" data-toggle="modal" data-target="#updateInventory">Update</button></td>
          ...
          <div class="row">
            <div class="col-6">
              ...
              <div class="form-group">
                ...
                <input type="text" name="vender_name" id="vender_name" class="form-control" placeholder="Vendor Contact Creator" readonly>
              </div>
            </div>
            <div class="col-6">
              <div class="form-group">
                <label for="">Title</label>
                <input type="text" name="inventory_title" id="inventory_title" class="form-control" placeholder="title">
              </div>
              <div class="form-group">
                <label for="">Gift value</label>
                <input type="text" name="value" id="value" class="form-control" placeholder="Type">
              </div>
              <div class="form-group">
...
<script>
  ...
  var getInventoryItem = function(inventory_item_id, vender_id){
    $.ajax({
      type : "POST",
      url : "<?php echo base_url();?>backend/Item_verification/getInventoryAprovalInfo",
      data : {inventory_item_id:inventory_item_id, vender_id:vender_id},
      success:function(data){
        var getInfo = JSON.parse(data);
        // console.log(getInfo.result);
        $("#vender_id").val(getInfo.result[0].vendor_id);
        $("#inventory_item_id").val(getInfo.result[0].id);
        $("#create_date").val(getInfo.result[0].create_date);
        ...
        $("#inventory_title").val(getInfo.result[0].gift_name);
        $("#value").val(getInfo.result[0].value);
        $("#quantity").val(getInfo.result[0].stock);
      }
    })
  }
  ...
  //   var inventory_title = $("#inventory_title").val();
  //   var value = $("#value").val();
  //   var quantity = $("#quantity").val();

  //   $.ajax({
  //     type: 'POST',
  //     url: '<?php echo base_url();?>backend/Item_verification/inventory_update',
  //     data : {vender_id:vender_id, inventory_item_id:inventory_item_id, create_date:create_date, store_name:store_name, category_id:category_id, vender_name:vender_name, inventory_title:inventory_title,value:value,quantity:quantity},
