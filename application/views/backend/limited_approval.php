              ...
              <div class="">
                ...
                <div class="table-responsive">
                  <table class="table  display">
                    ...
                    <tbody>
                      <?php $i=1;
                        if(!empty($limitedInfo)){
                          foreach($limitedInfo as $value){
                      ?>
                      <tr>
                        <td><?php echo $i; ?></td>
                        ...
                        <td><button class="btn btn-success" onclick="getLimitedItem('<?php echo $value['id']; ?>','<?php echo $value['vendor_id']; ?>');" data-toggle="modal" data-target="#updateLimited">Update</button></td>
...
<!-- The Modal -->
<div class="modal" id="updateLimited">
  <div class="modal-dialog">
    <div class="modal-content">
      <!-- Modal Header -->
      <div class="modal-header">
        <h4 class="modal-title">Update New Limited Approval</h4>
      ...
      <div class="modal-body">
        ...
        <form action="" method="POST" id="UpdateLimitedForm">
          <div class="row">
            <div class="col-6">
              <input type="hidden" name="limited_item_id" id="limited_item_id" value="">
              ...
              <div class="form-group">
                ...
                <input type="text" name="store_name" id="store_name" class="form-control" placeholder="Store Name" readonly>
              </div>
              <div class="form-group">
            ...
            <div class="col-6">
              ...
              <div class="form-group">
                ...
                <input type="text" name="limited_title" id="limited_title" class="form-control" plcaholder="title">
              </div>
            </div>
            <div class="col-12">
...
$("#warning").hide();
  ...
  var getLimitedItem = function(limited_item_id, vender_id){
    $.ajax({
      type : "POST",
      url : "<?php echo base_url();?>backend/Item_verification/getLimitedAprovalInfo",
      data : {limited_item_id:limited_item_id, vender_id:vender_id},
      success:function(data){
        var getInfo = JSON.parse(data);
        console.log(getInfo.result);
        $("#vender_id").val(getInfo.result[0].vendor_id);
        $("#limited_item_id").val(getInfo.result[0].id);
        ...
        $("#limited_title").val(getInfo.result[0].title);
      }
    })
  }
  ...
  //   var limited_item_id = $("#limited_item_id").val();
  //   var create_date = $("#create_date").val();
  //   var store_name = $("#store_name").val();
  //   var category_id = $("#category_id").val();
  //   var vender_name = $("#vender_name").val();
  //   var limited_title = $("#limited_title").val();

  //   $.ajax({
  //     type: 'POST',
  //     url: '<?php echo base_url();?>backend/Item_verification/limited_update',
  //     data : {vender_id:vender_id, limited_item_id:limited_item_id, create_date:create_date, store_name:store_name, category_id:category_id, vender_name:vender_name, limited_title:limited_title},
