  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="" method="POST" id="UpdateOfferForm">
          <div class="row">
            <div class="col-6">
              ...
              <div class="form-group">
                ...
                <input type="text" name="store_name" value="" id="store_name" class="form-control" placeholder="Store Name" readonly>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="vender_name" id="vender_name" value="" class="form-control" placeholder="Vendor Contact Creator" readonly>
              </div>
            </div>
            <div class="col-6">
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" name="saving_amount" id="saving_amount" min='0' value="" class="form-control" placeholder="Saving Value">
              </div>
            </div>
            <div class="col-12">
