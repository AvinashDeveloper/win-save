          ...
          <div class="row">
            ...
            <input type="hidden" name="setup_id" id="setup_id" value="">
              <div class="form-group">
                ...
                <input type="text" name="Uoffer_type" id="Uoffer_type" class="form-control">
              </div>
              <div class="form-group">
            ...
            <div class="col-6">
              ...
              <div class="form-group">
                ...
                <input type="file" name="Usetup_image" id="Usetup_image" class="form-control" value="">
