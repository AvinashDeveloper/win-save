      ...
      <div class="modal-dialog">
            <div class="modal-content">
                  ...
                  <div class="modal-body">
                        ...
                        <form action="<?php echo base_url('backend/Manage_vendors/savePromoClassified/').$vendor_id;?>" method="POST"  enctype="multipart/form-data" id="PromoClassifiedAddForm">
                              <div class="row">
                                    <div class="col-6">
...
<div class="modal" id="promoclassified_update">
      <div class="modal-dialog">
            <div class="modal-content">
                  ...
                  <div class="modal-body">
                        <!-- <?php //echo base_url();?>backend/Login/savePromoClassified/<?php// echo $this->uri->segment(4);?> -->
                        <form action="<?php echo base_url('backend/Manage_vendors/updatePromoClassified');?>" method="POST"  enctype="multipart/form-data" id="PromoClassifiedUpdateForm">
                              <div class="row">
                                    <div class="col-6">
                                          <div class="form-group">
                                                <label for="">Title</label>
                                    ...
                                    <div class="col-6">
                                          ...
                                          <div class="form-group">
                                                <label>Link</label>
                                                <input type="text" name="link" class="form-control" placeholder="Link" id="link_pc" value="">
                                          </div>
...
<script>
      $(document).ready(function() {
            var form = $('#PromoClassifiedAddForm');
      ...
      $(document).ready(function() {
            var form = $('#PromoClassifiedUpdateForm');
            var errorHandler1 = $('.errorHandler', form);
            var successHandler1 = $('.successHandler', form);
            form.validate({
                  errorElement: "span",
