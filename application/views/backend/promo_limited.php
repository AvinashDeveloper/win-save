      ...
      <div class="modal-dialog">
            <div class="modal-content">
                  ...
                  <div class="modal-body">
                        <form action="<?php echo base_url('backend/Manage_vendors/savePromoLimit/').$vendor_id;?>" method="POST"   enctype="multipart/form-data" id="PromoLimitedAddForm">
                              <div class="row">
                                    <div class="col-6">
...
<div class="modal" id="promolimit_update">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <!-- Modal body -->
                <div class="modal-body">
                    <form action="<?php echo base_url('backend/Manage_vendors/updatePromoLimit');?>" method="POST" enctype="multipart/form-data" id="PromoLimitedUpdateForm">
                            <div class="row">
                                <div class="col-6">
                                        <div class="form-group">
                                            <label for="">Title En.</label>
...
<script>
      ...
      $(document).ready(function() {
            var form = $('#PromoLimitedUpdateForm');
            var errorHandler1 = $('.errorHandler', form);
            var successHandler1 = $('.successHandler', form);
            form.validate({
                  errorElement: "span",
