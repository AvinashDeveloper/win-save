...
<div class="main-content-wrap sidenav-open d-flex flex-column">
	...
	<div class="main-content">
		<div class="breadcrumb">
			<h1 class="mr-2">Gift</h1>
			<ul>
				<li><a href="#">Admin</a></li>
				<li>Claimed Gift Record</li>
			</ul>
		</div>
			...
			<div class="card">
				<div class="card-header">
					<a class="collapsed card-link" data-toggle="collapse" href="#collapseTwo">
						1. Claimed Gift Record 
					</a>
					<a href="<?php echo base_url('backend/ExportIn/claimGift_record_csv'); ?>" class="btn btn-info">Export Csv</a>
				</div>
						...
						<div class="">
							<div class="table-responsive">
								<table class="table table-bordered table-striped  display">
									...
									<tbody>
										<?php $i=1;
											if(!empty($claim_gift_records)){
												foreach($claim_gift_records as $value){
										?>
										<tr> 
											<td><?php echo $value['voucher_code']; ?></td>
											<td><?php echo date('m/d/yy',$value['won_date']); ?></td>
											<td><?php echo $value['store_name']; ?></td>
											<td><?php echo cityString($value['branch_city']);?></td>
