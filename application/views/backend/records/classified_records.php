		...
		<div id="accordion">
			<div class="card">
				<div class="card-header">
					...
					<a href="<?php echo base_url('backend/ExportIn/classified_record_csv'); ?>" class="btn btn-info">Export Csv</a>
				</div>
						...
						<div class="">
							<div class="table-responsive">
								<table class="table table-bordered table-striped  display">
									...
									<tbody>
										<?php $i=1;
											if(!empty($classified_records)){
												foreach($classified_records as $value){	
										?>
										<tr> 
											<td><?php echo $i; ?></td>
											...
											<td><?php echo regionString($value['region']); ?></td>
