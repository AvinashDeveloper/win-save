		...
		<div id="accordion">
			<div class="card">
				<div class="card-header">
					...
					<a href="<?php echo base_url('backend/ExportIn/inventory_record_csv'); ?>" class="btn btn-info">Export Csv</a>
				</div>
									...
									<tbody>
                                        <?php $i=1;
                                            if(!empty($inventory_records)){
                                                foreach($inventory_records as $value){
                                        ?>
										<tr> 
											<td><?php echo $i; ?></td>
											<td><?php echo date('m/d/yy',strtotime($value['create_date'])); ?></td>
											<td><?php echo getCatgoryTypeString($value['category_id']); ?></td>
											<td><?php echo subCategoryTypeString($value['subcat_id']); ?></td>
											<td><?php echo $value['store_name']; ?></td>
											<td><?php echo $value['gift_title']; ?></td>
											<td><?php echo date('m/d/yy',strtotime($value['expire_date'])); ?></td>
											<td><?php echo $value['status']; ?></td>
											<td><?php echo $value['value']; ?></td>
											<td><?php echo $value['stock']; ?></td>
											<td><?php echo $value['claimed_count']; ?></td>
											<td><?php echo $value['not_claimed_count']; ?></td>
