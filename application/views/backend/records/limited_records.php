		...
		<div id="accordion">
			<div class="card">
				<div class="card-header">
					...
					<a href="<?php echo base_url('backend/ExportIn/limited_record_csv'); ?>" class="btn btn-info">Export Csv</a>
				</div>
						...
						<div class="">
							<div class="table-responsive">
								<table class="table table-bordered table-striped  display">
									...
									<tbody>
										<?php $i=1; 
											if(!empty($limited_records)){
												foreach($limited_records as $value){
										?>
										<tr> 
											<td><?php echo $i; ?></td>
