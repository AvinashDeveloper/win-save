		...
		<div id="accordion">
			<div class="card">
				<div class="card-header">
					...
					<a href="<?php echo base_url('backend/ExportIn/offers_record_csv'); ?>" class="btn btn-info">Export Csv</a>
				</div>
								...
								<table class="table table-bordered table-striped  display">
									<thead>
										<tr>
											...
											<th>Duration</th>
											<th>status</th>
											<th>number of redeemed offers</th>
									...
									<tbody>
                                        <?php $i=1;
                                            if(!empty($offers_records)){
                                                foreach($offers_records as $value){
                                        ?>
										<tr> 
											<td><?php echo $i; ?></td>
											...
											<td><?php echo $value['add_date']; ?></td>
											<td><?php echo $value['valid_date']; ?></td>
											<td><?php echo $value['status']; ?></td>
											<td><?php echo $value['redeemed_offers']; ?></td>
