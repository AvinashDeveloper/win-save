			...
			<div class="card">
				<div class="card-header">
					<a class="collapsed card-link" data-toggle="collapse" href="#collapseTwo">
						1. Unclaimed Gift Record
					</a>
					<a href="<?php echo base_url('backend/ExportIn/unclaimGift_record_csv'); ?>" class="btn btn-info">Export Csv</a>
				</div>
						...
						<div class="">
							<div class="table-responsive">
								<table class="table table-bordered table-striped  display">
									...
									<tbody>
										<?php $i=1;
											if(!empty($unclaim_gift_records)){
												foreach($unclaim_gift_records as $value){
										?>
										<tr> 
											<td><?php echo $value['voucher_code']; ?></td>
											<td><?php echo date('m/d/yy',strtotime($value['won_date'])); ?></td>
