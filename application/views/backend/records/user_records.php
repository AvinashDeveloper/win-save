		...
		<div id="accordion">
			<div class="card">
				<div class="card-header">
					...
					<a href="<?php echo base_url('backend/ExportIn/user_record_csv'); ?>" class="btn btn-info">Export Csv</a>
				</div>
								...
								<table class="table table-bordered table-striped  display">
									...
									<tbody>
										...
										<tr>
											...
											<td><a href=""><?php echo $value['user_email']; ?></a></td>
											...
											<td><?php echo $value['address']."<br>".countryString($value['user_country']); ?></td>
											<td><?php echo cityString($value['user_city']); ?></td>
											<td><?php echo getUserPlanSubscriptionStr($value['plan_id']); ?></td>
											<td><?php echo $value['expire_date']; ?></td>
											<td><?php echo $value['expire_account']; ?></td>
