		...
		<div id="accordion">
			<div class="card">
				<div class="card-header">
					...
					<a href="<?php echo base_url('backend/ExportIn/vendor_record_csv'); ?>" class="btn btn-info">Export Csv</a>
				</div>
									...
									<tbody>
										<?php echo $i=1;
											if(!empty($vendor_records)){
												foreach($vendor_records as $value){
										...
										<tr>
											...
											<td><a href=""><?php echo $value['store_name']; ?></a></td>
											<td><?php echo getCatgoryTypeString($value['category_id']); ?></td>
											<td><?php echo subCategoryTypeString($value['subcat_id']); ?></td>
											<td><?php echo $value['product']; ?></td>
											<td><?php echo $offer_detail; ?></td>
											<td><?php echo $total; ?></td>
											<td><?php echo getApproveStatusStr($value['approved_status']); ?></td>
