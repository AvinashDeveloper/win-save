...
<div class="main-content-wrap sidenav-open d-flex flex-column">
  ...
  <div class="main-content">
    ...
    <div class="card-header">
      <div class="col-md-4">
        <form method="GET" aaction="">
          <div class="row">
            <div class="col-md-2">
              <label>Pick Year</label>
            </div>
            <div class="col-md-8">
              <select class="form-control" name="year_filter" id="ddlyear"> 
                  ...
                  <?php $i=1;
                    ...
                    if(!empty($monthly_summary)){
                      foreach($monthly_summary as $value){
                        $TMonthUS = $TMonthUS + $value['MonthUS'];
                        $TMonthVS = $TMonthVS + $value['MonthVS'];
                        $TMonthC = $TMonthC + $value['MonthC'];
                        $TMonthL = $TMonthL + $value['MonthL'];
                        $TMonthI = $TMonthI + $value['MonthI'];
                        $TMonthR = $TMonthR + $value['MonthR'];
                        $TMonthRG = $TMonthRG + $value['MonthRG'];
                        $ttValue = $value['MonthUS'] + $value['MonthVS'] + $value['MonthC'] + $value['MonthL'];
                        $TTValue = $TTValue + $ttValue;
                  ?>
                  <tr>
                    <td><?php echo $value['month']; ?></td>
                    <td><?php echo $value['MonthUS']; ?></td>
                    <td><?php echo $value['MonthVS']; ?></td>
                    <td><?php echo $value['MonthC']; ?></td>
                    <td><?php echo $value['MonthL']; ?></td>
                    <td><?php echo $ttValue; ?></td>
                    <td><?php echo $value['MonthI']; ?></td>
                    <td><?php echo $value['MonthR']; ?></td>
                    <td><?php echo $value['MonthRG']; ?></td>
                  </tr>
                  <?php $i++; }} ?>
                </tbody>
                <tfoot>
                  <tr>
                    <th>Total</th>
                    <th><?php echo $TMonthUS; ?></th>
                    <th><?php echo $TMonthVS; ?></th>
                    <th><?php echo $TMonthC; ?></th>
                    <th><?php echo $TMonthL; ?></th>
                    <th><?php echo $TTValue; ?></th>
                    <th><?php echo $TMonthI; ?></th>
                    <th><?php echo $TMonthR; ?></th>
                    <th><?php echo $TMonthRG; ?></th>
                  </tr>
                </tfoot>
              </table>
            </div>
