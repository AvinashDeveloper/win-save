		...
		<div id="accordion3">
			...
			<div class="card">
				...
				<div id="collapseOne" class="collapse " data-parent="#accordion3">
					<div class="card-body">
						<form method="post" action="" id="StoreUpdateForm">
									...
									<div class="col-2">
										<div class="form-group">
											...
											<div class="avatar-upload">
												...
												<?php $i=1; if(!empty($vendorslider)) {foreach ($vendorslider as $key1) { ?>
												<div class="avatar-preview">
			...
			<div class="card">
				...
				<div id="e33" class="collapse" data-parent="#accordion3" class="form-control">
					<div class="card-body">
						<form action="" method="post" id="DisplayUpdateForm">
							<div class="row">
								<div class="col-3">
									<div class="form-group">
										<label>Website</label>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url('backend/Login/saveStoreBranch/').$this->uri->segment(4);?>" method="POST" id="BranchAddForm">
          <div class="row">
            <div class="col-6">
              <!-- <div class="form-group">
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body" id="form_input">
				<form action='<?php echo base_url("backend/Login/updateBranchInfo"); ?>' method='POST' id="BrachUpdateForm">
					<div class='row'>
							<div class='col-6'>
								<div class='form-group'>
										<label for=''>Branch Name En.</label>
