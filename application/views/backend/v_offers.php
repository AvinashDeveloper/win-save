    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo base_url('backend/Manage_vendors/saveOffers/').$vendor_id;?>" method="POST" id="OneOfferAddForm">
            <div class="row">
              <div class="col-6">
              ...
              <div class="col-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="stoke" class="form-control" placeholder="Quantity">
                </div>
                <div class="form-group">
                  <label for="">Limit per user</label>
                  <input type="number" name="limit_per_user" min='1' class="form-control" value="Limit per User">
                </div>
                <div class="form-group">
  ...
  <div class="modal" id="voucher">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <form action="<?php echo base_url('backend/Manage_vendors/saveOffers/').$vendor_id;?>" method="POST" id="VoucherAddForm">
            <div class="row">
              <div class="col-6">
                <div class="form-group">
                  <label for="">Create Date</label>
              ...
              <div class="col-6">
                ...
                <div class="form-group subCat_label">
                  <label><b>Sub Category:</b></label>
                  <div class="form-check-inline get_sub">
                  </div>
                </div>
                <div class="form-group">
                  <label>Aminities</label><br/>
                  <div class="form-group amt_label">
                    <br />
                    <div class="form-check-inline get_amt">
                    </div>
                  </div>
                </div>
  ...
  <div class="modal" id="afterbefore">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <form action="<?php echo base_url('backend/Manage_vendors/saveOffers/').$vendor_id;?>" method="POST" id="AfterBeforeAddForm">
            <div class="row">
              <div class="col-6">
                <div class="form-group">
                  <label for="">Create Date</label>
  ...
  <div class="modal" id="Percentage">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <form action="<?php echo base_url('backend/Manage_vendors/saveOffers/').$vendor_id;?>" method="POST" id="PercentageAddForm">
            <div class="row">
              <div class="col-6">
                <div class="form-group">
                  <label for="">Create Date</label>
  ...
  <div class="modal" id="sploffer">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <form action="<?php echo base_url('backend/Manage_vendors/saveOffers/').$vendor_id;?>" method="POST" id="SplOfferAddForm">
            <div class="row">
              <div class="col-6">
                <div class="form-group">
                  <label for="">Create Date</label>
  ...
  <div class="modal" id="onefreeoffer_update">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <form action="<?php echo base_url('backend/Manage_vendors/updateOffersInfo/').$vendor_id;?>" method="POST" id="OneOfferUpdateForm">
            <div class="row">
              <div class="col-6">
  ...
  <div class="modal" id="voucher_update">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <form action="<?php echo base_url('backend/Manage_vendors/updateOffersInfo');?>" method="POST" id="VoucherUpdateForm">
            <div class="row">
              <div class="col-6">
              ...
              <div class="col-6">
                ...
                <div class="form-group">
                  <label for="">Category Name</label>
                  <select class="form-control" name="category_id" id="Ucategory2" required="">
                    <?php echo categoryType(); ?>
                  </select>
                </div>
                <div class="form-group subCat_label">
  ...
  <div class="modal" id="afterbefore_update">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <form action="<?php echo base_url('backend/Manage_vendors/updateOffersInfo');?>" method="POST" id="AfterBeforeUpdateForm">
            <div class="row">
              <div class="col-6">
  ...
  <div class="modal" id="percentage_update">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <form action="<?php echo base_url('backend/Manage_vendors/updateOffersInfo');?>" method="POST" id="PercentageUpdateForm">
            <div class="row">
              <div class="col-6">
  ...
  <div class="modal" id="sploffer_update">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
          <form action="<?php echo base_url('backend/Manage_vendors/updateOffersInfo');?>" method="POST" id="SplOfferUpdateForm">
            <div class="row">
              <div class="col-6">
...
<script>
  ...
  $(document).ready(function() {
    var form = $('#AfterBeforeUpdateForm');
    var errorHandler1 = $('.errorHandler', form);
    var successHandler1 = $('.successHandler', form);
    form.validate({
      errorElement: "span",
