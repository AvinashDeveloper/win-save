	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?php echo base_url();?>backend/Supports/venderInfo_save" method="POST" id="AddVendorContactForm">
					<div class="row">
						<div class="col-6">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<form action="<?php //echo base_url('backend/Supports/findUs_update);?>" method="POST" id="UpdateVendorContactForm">
                    <div class="row">
						<div class="col-6">
                            <input type="hidden" name="venderS_id" id="VUvenderS_id" value="">
							<div class="form-group">
								<label for="">Question En.</label>
								<input type="text" name="VUtitle_en" id="VUtitle_en" class="form-control" placeholder="Title En" value="">
							</div>
							<div class="form-group">
								<label for="">Info</label>
								<input type="text" name="VUinfo" id="VUinfo" class="form-control" placeholder="Info" value="">
							</div>
						</div>
                        <div class="col-6">
							<div class="form-group">
								<label for="">Title Ar</label>
								<input type="text" name="VUtitle_ar" id="VUtitle_ar" class="form-control" placeholder="Title Ar" value="">
							</div>
                            <div class="form-group">
								<label>Priority</label>
								<input type="number" min='1' name="VUpriority" id="VUpriority" class="form-control" placeholder="set priority" value="">
							</div>
						</div>
						<div class="col-12">
...
<script>
	$(document).ready(function() {
		var form = $('#UpdateVendorContactForm');
