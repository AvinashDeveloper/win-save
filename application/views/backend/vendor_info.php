    ...
    <div id="accordion">
      ...
      <div class="card">
        ...
        <div id="collapseOne" class="collapse" data-parent="#accordion">
          <div class="card-body">
            <form action="" method="post" enctype='multipart/form-data' id="VenderDetailForm">
              ...
              <div class="row">
                <div class="col-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" name="Commerce_id" class="form-control" value="<?php print_r($store_setup[0]['id']);  ?>" readonly>
                  </div>
                  <div class="form-group">
                ...
                <div class="col-6">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="country">
                      <?php echo country((int)$store_setup[0]['country']); ?>
                    </select>
                  </div>
                  <div class="form-group">
                    <label for="">City</label>
                    <select class="form-control" name="city">
                     <?php echo city((int)$store_setup[0]['city']); ?>
                    </select>
                  </div>
                  <div class="form-group">
                  ...
                  <tbody>
                    ...
                    foreach ($ven_contacts as $key) { ?>
                      <tr>
                        ...
                        <td><?php echo roleString($key->vendor_role); ?></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="" id="VendorContactAddForm" method="POST">
          <div class="row">
            <div class="col-6">
              <div class="form-group">
            ...
            <div class="col-6">
              ...
              <div class="form-group">
                ...
                <select class="form-control vendor_role" name="vendor_role">
                  <?php echo getVendorRole(); ?>
                </select>
              </div>
            </div>
            <div class="col-12">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" id="form_input">
        <form action="<?php echo base_url(); ?>backend/Login/updateContactInfo" method='POST' id="ContactUpdateForm">
          <div class='row'>
                <div class='col-6'>
                      <div class='form-group'>
                            <label for=''>Title</label>
...
<script type="text/javascript">
  ...
  var updatePassword = function(contactId,vandorId){
    ...
    if(old_password == ""){alert('Please enter old password.');exit();}
    var new_password = $("#new_password").val();
    if(new_password == ""){alert('Please enter New password.');exit();}
    var confirm_password = $("#confirm_password").val();
    if(confirm_password == ""){alert("Please enter Confirm password");exit();}
    if(confirm_password !=  new_password){
      alert("Please enter same password");exit();
    }
...
<script>
  $(document).ready(function(){  
    $('.contactSave').click(function(){
      ...
      var v_id = $('.v_id').val();
      if(vendor_role==""){alert('Select role');exit();}
      var vendor_role = $('.vendor_role').val
      $.ajax({
        type:'POST',
        url:'<?php echo base_url(); ?>backend/Login/vender_contact',

        data :{title:title,name:name,contact:contact,email:email,note:note,status:status,v_id:v_id,vendor_role:vendor_role},
        success:function(data){
          alert('Contact Save');
          setTimeout(function(){
            location.reload(true);
