<div class="main-content-wrap sidenav-open d-flex flex-column">
          ...
          <div class="row">
            <!-- order-card start -->
            <div class="col-sm-12">
              <h4 class="page-title"><?php  $data['user_view'] =$this->Modlogin->user_view($this->uri->segment(2));
                               print_r($data['user_view'][0]['name']); ?> User List</h4>
                    ...
                    <div class="tab-pane active" id="home3" role="tabpanel">
                      <div class="table-responsive">
                        <table class="table table-hover" id="example">
                          ...
                          <tbody>
                            <?php  $i=1;foreach ($user_order_list as $key) {?>
                            <tr>
                              <td>
                                <?php echo $i; ?>
                              </td>
