	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?php echo base_url();?>backend/Supports/findUs_save" method="POST" id="AddForm">
					<div class="row">
						<div class="col-6">
...
<div class="modal" id="findUs_update">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<!-- Modal body -->
			<div class="modal-body">
				<form action="<?php //echo base_url('backend/Supports/findUs_update);?>" method="POST" id="helpUpdate-Form">
                    <div class="row">
						<div class="col-6">
                            <input type="hidden" name="find_id" id="FUfindUs_id" value="">
							<div class="form-group">
								<label for="">Question En.</label>
								<input type="text" name="title_en" id="FUtitle_en" class="form-control" placeholder="Title En" value="">
							</div>
							<div class="form-group">
								<label for="">Link</label>
								<input type="text" name="link" id="FUlink" class="form-control" placeholder="Link" value="">
							</div>
						</div>
                        <div class="col-6">
							<div class="form-group">
								<label for="">Title Ar</label>
								<input type="text" name="title_ar" id="FUtitle_ar" class="form-control" placeholder="Title Ar" value="">
							</div>
                            <div class="form-group">
								<label>Priority</label>
								<input type="number" min='1' name="priority" id="FUpriority" class="form-control" placeholder="set priority" value="">
							</div>
						</div>
						<div class="col-12">
