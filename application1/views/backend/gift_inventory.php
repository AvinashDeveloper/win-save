                   ...
                   <td><?php echo $key->added_date;  ?></td>
                    ...
                    <td><?php echo $key->gift_name;?></td>
                     ...
                     <td><?php echo translateText($key->gift_description);//gift_detail;?></td>
                        <td><?php echo $key->req_points ;?></td>
                      
                           <td><?php echo $key->stock ;?></td>
                             <td><?php echo$key->req_points* $key->stock ;?></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url();?>backend/Login/saveGiftinventory/<?php echo $this->uri->segment(4);?>" method="POST"  enctype="multipart/form-data">
          <div class="row">
            <div class="col-6">
