      ...
      <div class="modal-body">
        ...
        <div class="row">
            ...
            <input type="hidden" name="district_id" id="ud_district_id" value="">
                ...
                <select class="form-control" name="country_id" id="ud_country_id">
                ...
                <select class="form-control" name="region_id" id="ud_region_id">
                ...
                <select class="form-control" name="city_id" id="ud_city_id">
                ...
                <input type="text" class="form-control" name="district_name_en" id="ud_dictrict_name_en" value="">
            </div>
                 <div class="form-group">
                <label for="">District Arabic</label>
                <input type="text" class="form-control" name="district_name_ar" id="ud_dictrict_name_ar" value="">
            </div>
            </div>
             <div class="col-6">
              ...
              <input type="number" name="priority" id="ud_priority" class="form-control" min="1"  value="" placeholder="Priorty Listing">
            </div>
       ...
       <div class="modal-body">
        ...
        <div class="row">
            <div class="col-6">
                      <div class="form-group">
                <label for="">Country English</label>
                <select class="form-control" name="country" id="da_country_id">
                    <option value="">Select country</option>
                 <?php echo country(); ?>
               </select>
            </div>
                   <div class="form-group">
                <label for="">Region English</label>
                <select class="form-control" name="region" id="da_region_id">
                    <option value="">Select Region</option>                 
               </select>
            </div>
                  <div class="form-group">
                <label for="">City English</label>
                <select class="form-control" name="city" id="da_city_id">
                 <option value="">Select City</option>
               </select>
            </div>
             ...
             <div class="col-6">
              ...
              <div class="form-group">
                <label for="">Priorty Listing</label>
              <input type="number" name="priority" id="da_priority" class="form-control" placeholder="Priorty Listing">
            </div>
              <div class="form-group">
                <label for="">District English</label>
                <input type="text" class="form-control" name="district_name_en" id="da_district_name_en">
            </div>
                 <div class="form-group">
                <label for="">District Arabic</label>
                <input type="text" class="form-control" name="district_name_ar" id="da_district_name_ar">
            </div>
             </div>
             <div class="col-12">
