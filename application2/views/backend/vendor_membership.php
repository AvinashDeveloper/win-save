            ...
            <thead>
             ...
             <tbody>
               <tr>
                   ...
                   <tr>
                      <td>3</td>
                   <td>Sliver - 6 Month</td>
                    <td>Offers Submission</td>
                     <td>Used a Directory Only</td>
                     <td>0</td>
                     <td>Unlimited</td>
                     <td>No</td>
       ...
       <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <label for="">Show on Feature</label>
                <br/>
                <label>Yes
              <input type="checkbox" name="show_feat" class="form-control" value="yes"></label>
                <label>No
              <input type="checkbox" name="show_feat" class="form-control" value="No"></label>
            </div>
            <div class="form-group">
                <label for="">Show on Notification</label>
              <br/>
                <label>Yes
              <input type="checkbox" name="show_feat" class="form-control" value="yes"></label>
                <label>No
