...
<div class="modal" id="updateCountry">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url();?>backend/Settings/country_update" method="POST" enctype="multipart/form-data">
                <div class="row">
...
<div class="modal" id="addCountry">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <!-- Modal body -->
            <div class="modal-body">
            <form action="<?php echo base_url();?>backend/Settings/country_save" enctype="multipart/form-data" method="post">
                <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        <label for="">Country Name English</label>
                        <input type="text" name="country_name_en" class="form-control" placeholder="country name en">
                    </div>
                    <div class="form-group">
                        <label for="">Country Name Arabic</label>
                        <input type="text" name="country_name_ar" class="form-control" placeholder="country name ar">
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group">
                    <label for="">Upload image</label>
                    <input type="file" name="country_flag" class="form-control" placeholder="Images">
                    </div>
                    <div class="form-group">
                    <label for="">Priorty Listing</label>
                    <input type="number" name="priority" class="form-control" placeholder="Priorty Listing">
                    </div>
                </div>
                <div class="col-12">
