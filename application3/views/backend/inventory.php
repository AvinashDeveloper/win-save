                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-6">
                        ...
                        <div class="form-group">
                         ...
                         <input type="text" readonly="" name="gen_code"  class="form-control" id="gen_code" value="<?php  echo $all_venders_list[0]->generated_code; ?>" >

                         <input type="hidden" name="random_code"  class="form-control" value="<?php  echo $all_venders_list[0]->generated_code; ?>">
