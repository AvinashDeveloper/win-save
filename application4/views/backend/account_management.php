      ...
      <div class="modal-dialog">
            <div class="modal-content">
                  ...
                  <div class="modal-body">
                        <form action="<?php echo base_url('backend/Login/saveMembershipOrder/').$vandor_id;?>" method="POST">
                              <div class="row">
                                    <div class="col-6">
                                          <div class="form-group">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body" id="membershipOrderForm">
				<form action='<?php echo base_url(); ?>backend/Login/updateMembershipOrdre' method='POST'>
					...
					<div class='col-6'>
						...
						<div class='form-group'>
								<label for=''>Vat 5%</label>
								<input type='number' id='M_vat' name='vat' class='form-control' value='5' placeholder='vat' readonly>
						</div>
						<div class='form-group'>
								<label for=''>Total</label>
...
<div class="modal" id="classified_add">
      <div class="modal-dialog">
            <div class="modal-content">
                  ...
                  <!-- Modal body -->
                  <div class="modal-body">
                        <form action="<?php echo base_url('backend/Login/saveClassifiedOrder/').$vandor_id;?>" method="POST">
                              <div class="row">
                                    <div class="col-6">
                                          <div class="form-group">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body" id="classifiedOrderForm">
				<form action='<?php echo base_url(); ?>backend/Login/updateClassifiedOrdre' method='POST'>
					<div class='row'>
						<div class='col-6'>
								<div class='form-group'>
									<label for=''>Date</label>
						...
						<div class='col-6'>
								...
								<div class='form-group'>
									<label for=''>Vat 5%</label>
									<input type='number' name='vat' id='cu_vat' value="5" class='form-control' value='' readonly>
								</div>
								<div class='form-group'>
									<label for=''>Total</label>
...
<div class="modal" id="limited_add">
      <div class="modal-dialog">
            <div class="modal-content">
                  ...
                  <!-- Modal body -->
                  <div class="modal-body">
                        <form action="<?php echo base_url('backend/Login/saveLimitedOrder/').$vandor_id;?>" method="POST">
                              <div class="row">
                                    <div class="col-6">
                                          <div class="form-group">
                                                <label for="">Date</label>
                                    ...
                                    <div class="col-6">
                                          ...
                                          <div class="form-group">
                                                <label for="">Vat 5%</label>
                                                <input type="number" name="vat" id="l_vat" value="5" class="form-control" placeholder="Vat" readonly>
                                          </div>
                                          <div class="form-group">
                                                <label for="">Total</label>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body" id="limitedOrderForm">
				<form action='<?php echo base_url(); ?>backend/Login/updateLimitedOrdre' method='POST'>
					<div class='row'>
							<div class='col-6'>
								<div class='form-group'>
										<label for=''>Date</label>
							...
							<div class='col-6'>
								...
								<div class='form-group'>
										<label for=''>Vat 5%</label>
										<input type='number' name='vat' value="5" id='lu_vat' class='form-control' value='' readonly>
								</div>
								<div class='form-group'>
										<label for=''>Total</label>
