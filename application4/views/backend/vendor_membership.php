          ...
          <div class="row">
            <div class="col-6">
              ...
              <div class="form-group">
                ...
                <input type="text" name="plan_type" id="Uplan_type" value="" class="form-control">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" id="Upackage_details" name="package_details"></textarea>
              </div>
              <div class="form-group">
                <label for="">offer_limit</label>
                <input type="text" name="offer_limit" id="Uoffer_limit" class="form-control">
              </div>
              <div class="form-group">
                <label for="">branch_limit</label>
                <input type="text" name="branch_limit" id="Ubranch_limit" class="form-control">
              </div>
              <div class="form-group">
                <label for="">Priorty Listing</label>
                <input type="number" name="priority_display" id="Upriority_display" class="form-control" value="">
              </div>
            </div>
            <div class="col-6">
              <div class="form-group">
                <label for="">Show on Feature</label><br/>
                <label>Yes<input type="checkbox" name="feature_view[]" class="form-control Ufeature_view" value="Yes"></label>
                <label>No<input type="checkbox" name="feature_view[]" class="form-control Ufeature_view" value="No"></label>
              </div>
              <div class="form-group">
                <label for="">Show on Notification</label><br/>
                <label>Yes<input type="checkbox" name="notification_alert[]" class="form-control Unotification_alert" value="yes"></label>
                <label>No<input type="checkbox" name="notification_alert[]" class="form-control Unotification_alert" value="No"></label>
              </div>
              <div class="form-group">
                <label for="">Price</label>
                <input type="text" name="main_amount" id="Umain_amount" class="form-control" value="">
              </div>
              <div class="form-group">
                <label for="">Discount</label>
                <input type="text" name="discount" id="Udiscount" class="form-control" value="">
              </div>
              <div class="form-group">
                <label for="">After Discount</label>
                <input type="text" name="offer_amount" id="Uoffer_amount" class="form-control" value="">
              </div>
            </div>
            <div class="col-12">
        ...
        <form action="" method="POST">
          <div class="row">
            <div class="col-6">
              ...
              <div class="form-group">
                <label for="">Priorty Listing</label>
                <input type="number" name="priority" id="priority" class="form-control" placeholder="priority display">
              </div>
            </div>
            <div class="col-6">
              <div class="form-group">
                <label for="">Show on Feature</label><br/>
                <label>Yes<input type="checkbox" name="feature_view[1][]" class="form-control feature_view" value="Yes"></label>
                <label>No<input type="checkbox" name="feature_view[1][]" class="form-control feature_view" value="No"></label>
              </div>
              <div class="form-group">
                <label for="">Show on Notification</label><br/>
                <label>Yes<input type="checkbox" name="notification_alert[1][]" class="form-control notification_alert" value="Yes"></label>
                <label>No<input type="checkbox" name="notification_alert[1][]" class="form-control notification_alert" value="No"></label>
              </div>
              <div class="form-group">
                <label for="">Price</label>
