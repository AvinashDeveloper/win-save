    ...
    <div class="side-content-wrap">
        <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
            <ul class="navigation-left">
                ...
                <li class="nav-item" data-item="manage_ads"><a class="nav-item-hold" href="<?php echo base_url(); ?>vender-aminity"><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Slider & Alerts</span></a>
                    <div class="triangle"></div>
                </li>
                ...
                <li class="nav-item" data-item="record_list"><a class="nav-item-hold" href=""><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Records List</span></a>
                    <div class="triangle"></div>
                </li>

                <li class="nav-item" data-item="report_list"><a class="nav-item-hold" href=""><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Reports List</span></a>
                    <div class="triangle"></div>
                </li>

                <li class="nav-item" data-item="system_setting"><a class="nav-item-hold" href=""><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Syetem Settings</span></a>
                    <div class="triangle"></div>
                </li>

                <li class="nav-item" data-item="admin_setting"><a class="nav-item-hold" href=""><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Admin Settings</span></a>
                    <div class="triangle"></div>
                </li>

                <li class="nav-item" data-item="reward_gift"><a class="nav-item-hold" href="<?php echo base_url(); ?>vender-aminity"><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Rewards & Gift</span></a>
                    <div class="triangle"></div>
                </li>

                <li class="nav-item" data-item="settings"><a class="nav-item-hold" href="<?php echo base_url(); ?>vender-aminity"><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Settings</span></a>
                    <div class="triangle"></div>
                </li>

                <li class="nav-item" data-item="venderItemVerfication"><a class="nav-item-hold" href="<?php echo base_url(); ?>vender-aminity"><i class="nav-icon i-Computer-Secure"></i><span class="nav-text">Vender Item Verification</span></a>
                    <div class="triangle"></div>
                </li>
        ...
        <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
            ...
            <ul class="childNav" data-parent="manage_ads">
                <li class="nav-item"><a href="<?php echo base_url(); ?>slide-ads"><i class="nav-icon i-File-Clipboard-Text--Image"></i><span class="item-name">Slides</span></a></li>
                ...
                <li class="nav-item"><a href="<?php echo base_url(); ?>news-save"><i class="nav-icon i-Width-Window"></i><span class="item-name">News Alerts</span></a></li>
            ...
            <ul class="childNav" data-parent="apps">
                ...
                <li class="nav-item"><a href="<?php echo base_url();?>Vender-membership"><i class="nav-icon i-Speach-Bubble-3"></i><span class="item-name">Vender Membership</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url();?>User-membership"><i class="nav-icon i-Speach-Bubble-3"></i><span class="item-name">User Membership</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url();?>Offer-setup"><i class="nav-icon i-Speach-Bubble-3"></i><span class="item-name">Offer Setup</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url();?>Classified-setup"><i class="nav-icon i-Speach-Bubble-3"></i><span class="item-name">Classified Setup</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url();?>Limited-setup"><i class="nav-icon i-Speach-Bubble-3"></i><span class="item-name">Limited Setup</span></a></li>
            </ul>
            ...
            <ul class="childNav" data-parent="extrakits">
                ...
                <li class="nav-item"><a href="<?php echo base_url();  ?>all-users"><i class="nav-icon i-Crop-2"></i><span class="item-name">User List</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url();  ?>Renew-users-subscription"><i class="nav-icon i-Crop-2"></i><span class="item-name">Renew User Subscription</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url();  ?>Users-view"><i class="nav-icon i-Crop-2"></i><span class="item-name">User View</span></a></li>
                ...
                <li class="nav-item"><a href="<?php echo base_url(); ?>User-comments"><i class="nav-icon i-Loading-3"></i><span class="item-name">User Comment & Review</span></a></li>
            ...
            <ul class="childNav" data-parent="uikits">
                ...
                <li class="nav-item"><a  href="<?php echo base_url();  ?>provide-plan-vender"><i class="nav-icon i-Bell1"></i><span class="item-name">Provide Vender's Plan</span></a></li>
            ...
            <ul class="childNav" data-parent="support">
                <li class="nav-item"><a href="<?php echo base_url(); ?>help"><i class="nav-icon i-Find-User"></i><span class="item-name">Help instruction</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>rules"><i class="nav-icon i-Find-User"></i><span class="item-name">Rules of Use</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>find_us"><i class="nav-icon i-Find-User"></i><span class="item-name">Find Us</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>contact_us"><i class="nav-icon i-Find-User"></i><span class="item-name">Contact Us</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>for_venders"><i class="nav-icon i-Find-User"></i><span class="item-name">For Venders</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>about_us"><i class="nav-icon i-Find-User"></i><span class="item-name">About Us</span></a></li>
            </ul>

            <ul class="childNav" data-parent="record_list">
                <li class="nav-item"><a href="<?php echo base_url(); ?>Users-records"><i class="nav-icon i-Find-User"></i><span class="item-name">Users Records</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Vendor-records"><i class="nav-icon i-Find-User"></i><span class="item-name">Vendor Records</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Offer-records"><i class="nav-icon i-Find-User"></i><span class="item-name">Offer records</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Classified-records"><i class="nav-icon i-Find-User"></i><span class="item-name">Classified Records</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Limited-records"><i class="nav-icon i-Find-User"></i><span class="item-name">Limited Records</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Claimed-offer-records"><i class="nav-icon i-Find-User"></i><span class="item-name">Claimed Offers Records</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Claimed-gift-records"><i class="nav-icon i-Find-User"></i><span class="item-name">Claimed Gift Records</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Unclaimed-gift-records"><i class="nav-icon i-Find-User"></i><span class="item-name">Unclaimed Gift Records</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Inventory-records"><i class="nav-icon i-Find-User"></i><span class="item-name">Inventory List</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Comments-records"><i class="nav-icon i-Find-User"></i><span class="item-name">Comments Records</span></a></li>
            </ul>

            <ul class="childNav" data-parent="report_list">
                <li class="nav-item"><a href="<?php echo base_url(); ?>Monthly-summary"><i class="nav-icon i-Find-User"></i><span class="item-name">Monthly summary</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>User-activity"><i class="nav-icon i-Find-User"></i><span class="item-name">Users Activity</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Vendor-activity"><i class="nav-icon i-Find-User"></i><span class="item-name">Vendors activity</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>User-subscription"><i class="nav-icon i-Find-User"></i><span class="item-name">Users subscription</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Vendor-subscription"><i class="nav-icon i-Find-User"></i><span class="item-name">Vendors subscription</span></a></li>
            </ul>

            <ul class="childNav" data-parent="reward_gift">
                <li class="nav-item"><a href="<?php echo base_url(); ?>Rewards-level"><i class="nav-icon i-Find-User"></i><span class="item-name">Rewards Level</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Gift-senario"><i class="nav-icon i-Find-User"></i><span class="item-name">Assign Gift Scenario</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Manage-gift"><i class="nav-icon i-Find-User"></i><span class="item-name">Manage Gifts</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Inventory-traking"><i class="nav-icon i-Find-User"></i><span class="item-name">Inventory Tracking</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Point-claiming"><i class="nav-icon i-Find-User"></i><span class="item-name">Points Claiming Setup</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Point-adjust"><i class="nav-icon i-Find-User"></i><span class="item-name">Points Adjust</span></a></li>
            </ul>

            <ul class="childNav" data-parent="admin_setting">
                <li class="nav-item"><a href="<?php echo base_url(); ?>Manage-profile"><i class="nav-icon i-Find-User"></i><span class="item-name">Manage profile</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Manage-roles"><i class="nav-icon i-Find-User"></i><span class="item-name">Manage roles</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Manage-vendor-contact-role"><i class="nav-icon i-Find-User"></i><span class="item-name">Manage vendor contact roles</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Manage-managers"><i class="nav-icon i-Find-User"></i><span class="item-name">Manage managers</span></a></li>
            </ul>

            <ul class="childNav" data-parent="system_setting">
                <li class="nav-item"><a href="<?php echo base_url(); ?>Vat-setup"><i class="nav-icon i-Find-User"></i><span class="item-name">Vat Setup</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Currency-setup"><i class="nav-icon i-Find-User"></i><span class="item-name">Currency Setup</span></a></li>
            </ul>

            <ul class="childNav" data-parent="venderItemVerfication">
                <li class="nav-item"><a href="<?php echo base_url(); ?>Offer-aproval"><i class="nav-icon i-Find-User"></i><span class="item-name">New Offer Aproval</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Classified-aproval"><i class="nav-icon i-Find-User"></i><span class="item-name">New Classified Aproval</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Limited-aproval"><i class="nav-icon i-Find-User"></i><span class="item-name">New Limited Aproval</span></a></li>
                <li class="nav-item"><a href="<?php echo base_url(); ?>Inventory-aproval"><i class="nav-icon i-Find-User"></i><span class="item-name">New Inventory Aproval</span></a></li>
            </ul>

            <ul class="childNav" data-parent="settings">
                <li class="nav-item"><a href="<?php echo base_url(); ?>nationality"><i class="nav-icon i-Find-User"></i><span class="item-name">Nationality</span></a></li>

                <li class="nav-item"><a href="<?php echo base_url(); ?>country"><i class="nav-icon i-Find-User"></i><span class="item-name">Country</span></a></li>

                <li class="nav-item"><a href="<?php echo base_url(); ?>region"><i class="nav-icon i-Find-User"></i><span class="item-name">Region</span></a></li>

                <li class="nav-item"><a href="<?php echo base_url(); ?>city"><i class="nav-icon i-Find-User"></i><span class="item-name">City</span></a></li>

                <li class="nav-item"><a href="<?php echo base_url(); ?>district"><i class="nav-icon i-Find-User"></i><span class="item-name">District</span></a></li>
            </ul>
