                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="country_id" id="u_country_id">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="u_region_id" name="region_id">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="city_name_en" class="form-control" id="u_city_name_en">
                            </div>
                            <div class="form-group">
                                <label for="">City Arabic</label>
                                <input type="text" name="city_name_ar" class="form-control" id="u_city_name_ar">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="">Priorty Listing</label>
                                <input type="number" name="priority" min="1" class="form-control" id="u_priority" value="" placeholder="Priorty Listing">
                            </div>
                        </div>
                        <div class="col-12">
                ...
                <form action="" method="POST">
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="">Country English</label>
                                <select class="form-control" name="country_id" id="a_country_id">
                                    <option value="">Select Country</option>
                                    <?php echo country(); ?>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="">Region English</label>
                                <select class="form-control" name="region_id" id="a_region_id">
                                    
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="">City English</label>
                                <input type="text" class="form-control" name="city_name_en" id="a_city_name_en">
                            </div>
                            <div class="form-group">
                                <label for="">City Arabic</label>
                                <input type="text" class="form-control" name="city_name_ar" id="a_city_name_ar">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="">Priorty Listing</label>
                                <input type="number" name="priority" min="1" id="a_priority" class="form-control" placeholder="Priorty Listing">
                            </div>
                        </div>
                        <div class="col-12">
