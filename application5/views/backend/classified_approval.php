          ...
          <div class="row">
            <div class="col-6">
              ...
              <div class="form-group">
                ...
                <input type="text" name="store_name" id="store_name" class="form-control" plcaholder="Store Name">
              </div>
              <div class="form-group">
            ...
            <div class="col-6">
              <div class="form-group">
                ...
                <input type="text" name="vender_name" id="vender_name"  class="form-control" plcaholder="Vendor Contact Creator">
              </div>
              <div class="form-group">
