                ...
                <table class="table table-bordered table-striped  display">
                  <thead>
                    <tr>
                      ...
                      <th>Total store viewed</th>
                      <th>Total shared link</th>
                      ...
                      <th>total subscriptions paid</th>
                    </tr>
                  </thead>
                  <tbody>
                    <?php $i=1;
                    ...
                    <tr>
                      ...
                      <td><?php echo $value['current_plan']; ?></td>
                      <td><?php echo $value['store_view']; ?></td>
                      <td><?php echo $value['link_share']; ?></td>
                      <td><?php echo $value['store_rate']; ?></td>
                      <td><?php echo $value['store_comment']; ?></td>
                      <td><?php echo $value['offer_redeem']; ?></td>
                      <td><?php echo $value['amount_saved']; ?></td>
                      <td><?php echo $value['point_redeem']; ?></td>
                      <td><?php echo $value['gift_redeem']; ?></td>
