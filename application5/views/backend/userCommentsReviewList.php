            ...
            <div class="main-content">
                <div class="breadcrumb">
                    ...
                    <ul>
                        ...
                        <li>User List Comments Review</li>
...
<table class="table  display">
  <thead>
    <tr>
      ...
      <th>Rated</th>
      <th>Comments</th>
      <th>Flaged Comments By visitors</th>
      <!-- <th>View / Edit</th> -->
      <th>Remove</th>
    </tr>
  </thead>
  <tbody>
    ...
    ?>
    <tr id="row_<?php echo $value['review_id'];?>">
      ...
      <td><span class="text-danger" onclick="deleteRow('<?php echo  $value['review_id']; ?>');"><i class="fa fa-close"></i></span></td>
    </tr>
    <?php $i++; } } ?>
  </tbody>
</table>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Update User List Comments Review</h4>
        ...
        <div class="row">
            <div class="col-6">
             ...
             <div class="col-6">
               <div class="form-group">
                <label>Rated</label>
               <input type="text" name="Name" class="form-control" value="Rated">
            </div>
                     <div class="form-group">
                <label for="">E-mail</label>
                <input type="email" name="type" class="form-control" value="email">
            </div>
             <div class="form-group">
                <label for="">Flaged Comments By Visitors</label>
        <input type="text" name="title" class="form-control" value="Flaged Comments By Visitors">
            </div>
  ...
  var deleteRow = function(id) {
      ...
      if (result) {
            ...
            $.ajax({
                  type: "POST",
                  url: url,
                  data: {id: id,tbl:'vendor_ratting',col_name:'review_id'},
            })
