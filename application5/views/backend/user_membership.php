          ...
          <div class="row">
            <div class="col-6">
              ...
              <div class="form-group">
                ...
                <input type="text" name="plan_type_en" id="Uplan_type_en" value="" class="form-control">
              </div>
              <div class="form-group">
                <label for="">Plan Arabic</label>
                <input type="text" name="plan_type_ar" id="Uplan_type_ar" value="" class="form-control">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="subscription_limit" id="Usubscription_limit" value="">
              </div>
              <!-- <div class="form-group">
            ...
            <div class="col-6">
              <div class="form-group">
                ...
                <label>Yes<input type="checkbox" name="collect_point[]" class="form-control Ucollect_point" value="Yes"></label>
                <label>No<input type="checkbox" name="collect_point[]" class="form-control Ucollect_point" value="No"></label>
              </div>
              <div class="form-group">
                <label for="">Claim Offers</label><br/>
                <label>Yes<input type="checkbox" name="offer_claim[]" class="form-control Uoffer_claim" value="Yes"></label>
                <label>No<input type="checkbox" name="offer_claim[]" class="form-control Uoffer_claim" value="No"></label>
              </div>
              <div class="form-group">
                <label for="">Redeem Gifts</label><br/>
                <label>Yes<input type="checkbox" name="redeem_gift[]" class="form-control Uredeem_gift" value="Yes"></label>
                <label>No<input type="checkbox" name="redeem_gift[]" class="form-control Uredeem_gift" value="No"></label>
              </div>
              <div class="form-group">
                <label for="">Price</label>
                <input type="number" name="main_amount" id="Umain_amount" class="form-control" value="">
              </div>
              <div class="form-group">
                <label for="">Discount</label>
                <input type="number" name="discount" id="Udiscount" class="form-control" value="">
              </div>
              <div class="form-group">
                <label for="">After Discount</label>
                <input type="number" name="offer_amount" id="Uoffer_amount" class="form-control" value="">
              </div>
            </div>
            <div class="col-12">
