      ...
      <div class="modal-body">
        ...
        <form enctype="multipart/form-data"  id="aminityupdates"  method="POST" >
          <div class="col-xl-12">
              <div class="form-group">
                <label>Category Name</label>
                <select class="category_list form-control" name="c_id" id="cat_id">
                  <option value="">Select Category</option>
                  <?php echo categoryType();?>
                </select>
              </div>
              <div class="form-group">
                ...
                <input type="text" name="name" id="amitniy_name" class="form-control name">
              </div>
              <input type="hidden" name="id" value="" id="row_id">
              <input type="hidden" name="featured_image" value="" id="featured_image">
              <div class="featured_image"></div>
              <div class="form-group">
                <label>Image</label>
                <input type="file" name="userfile" id="Uuserfile" class="form-control userfile">
              </div>
