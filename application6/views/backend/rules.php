	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="<?php echo base_url();?>backend/Supports/rule_save" method="POST">
					<div class="row">
						<div class="col-6">
							...
							<div class="form-group">
								...
								<textarea name="desc_en" class="form-control" placeholder="Description En"></textarea>
							</div>
							<div class="form-group">
								<label>Priority</label>
								<input type="number" min='1' name="priority" class="form-control" placeholder="set priority">
							</div>
						</div>
            			<div class="col-6">
							<div class="form-group">
							...
							<div class="form-group">
								...
								<textarea name="desc_ar" class="form-control" placeholder="Description Ar"></textarea>
							</div>
						</div>
						<div class="col-12">
...
<div class="modal" id="rule_update">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<!-- Modal body -->
			<div class="modal-body">
				<form action="<?php echo base_url();?>backend/Supports/rule_update" method="POST">
        <div class="row">
						<div class="col-6">
              <input type="hidden" name="rule_id" id="rule_id" value="">
							<div class="form-group">
								<label for="">Title En.</label>
								<input type="text" name="title_en" id="Rtitle_en" class="form-control" placeholder="Title En">
							</div>
							<div class="form-group">
								<label for="">Description En</label>
								<textarea name="desc_en" id="Rdesc_en" class="form-control" placeholder="Description En"></textarea>
							</div>
							<div class="form-group">
								<label>Priority</label>
								<input type="number" min='1' name="priority" id="Rpriority" class="form-control" placeholder="set priority">
							</div>
						</div>
            <div class="col-6">
							<div class="form-group">
								<label for="">Title Ar</label>
								<input type="text" name="title_ar" id="Rtitle_ar" class="form-control" placeholder="Title Ar">
							</div>
							<div class="form-group">
								<label for="">Description Ar</label>
								<textarea name="desc_ar" id="Rdesc_ar" class="form-control" placeholder="Description Ar"></textarea>
							</div>
						</div>
						<div class="col-12">
