    ...
    <div id="accordion">
      <div class="card">
        ...
        <div id="collapseTwo" class="collapse show" data-parent="#accordion">
          <div class="card-body">
            <form action="<?php echo base_url('Renew-users-subscription/').$this->uri->segment(2);?>" method="POST">
              ...
              <div class="row">
                <div class="col-4">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" name="expire_date" id="expire_date" class="form-control"  value="<?php echo $user_info[0]->expire_date?>">
                  </div>
                  <div class="form-group">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <input type="date" name="start_date" id="start_date" class="form-control" value="<?php echo $user_info[0]->start_date?>" >
              </div>
              <div class="form-group">
                <label for="">Expire Date</label>
                <input type="date" name="end_date" id="end_date" class="form-control" value="<?php echo $user_info[0]->expire_date?>" 
              <div class="form-group">
