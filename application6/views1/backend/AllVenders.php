                          ...
                          <tbody>
                           <?php $i=1;foreach ($all_venders_list as $key) {?>
                            <tr>
                              ...
                              <td><?php   $data['get_subcategorybyid']=$this->Modlogin->get_subcategorybyid($key->subcat_id); print_r($data['get_subcategorybyid'][0]->name); ?></td>
                              ...
                              <td><?php  $key->plan_id; $data['check_vendercls_offer']=$this->ModVender->check_vendercls_offer($key->id); if ($data['check_vendercls_offer']) {
                                echo "Yes";
                              }else{echo "No";}?></td>
                              <td><?php  $key->plan_id; $data['check_venderlimited_offer']=$this->ModVender->check_venderlimited_offer($key->id); if ($data['check_venderlimited_offer']) {
                                echo "Yes";
                              }else{echo "No";}?></td>
                              <td><?php if ($key->approved_status==1) {
                                echo "Yes";
                              }else{echo "No";}  ?></td>
